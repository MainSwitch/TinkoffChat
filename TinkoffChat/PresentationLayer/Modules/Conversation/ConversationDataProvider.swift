...
class ConversationDataProvider: NSObject {
    ...
    init(tableView: UITableView, conversationId: String) {
        ...
        self.fetchedResultsController =
            NSFetchedResultsController<Message>(fetchRequest: fetchRequest, managedObjectContext:
                AppDelegate.rootAssembly.presentationAssembly.coreDataFacade.mainContext, sectionNameKeyPath:
                nil, cacheName: nil)
        super.init()
