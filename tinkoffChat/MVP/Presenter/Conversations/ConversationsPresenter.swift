...
class ConversationsPresenter {
    ...
    func loadMassage() {
        ...
        massageModelArray.append(MassageModel(name: "Edgar", massage: "How are you?", date: Date(timeIntervalSinceReferenceDate: -1), online: true, hasUnreadMassages: false))
        ...
        massageModelArray.append(MassageModel(name: "SomeGuy", massage: "Hello)))))))", date: Date(timeIntervalSinceNow: -1500), online: false, hasUnreadMassages: false))
